namespace EasyViewer.Helpers.Creators.SouthPark
{
    ...
    public static class SPFreehat
    {
        ...
        public static Uri GetSpAddressFreehat(int seasonNum, int episodeNum)
        {
            var fullNum = seasonNum * 100 + episodeNum;
            var voice = GetSpVoiceNameFreehat(seasonNum, episodeNum);

            switch (seasonNum)
            {
                case 1: return new Uri($"https://free.freehat.cc/sppar/free/{fullNum}_{voice}.mp4");
                case 17:
                case 18:
                case 19:
                case 20:
                ...
                case 22:
                case 23:
                case 24: return new Uri($"https://serv1.freehat.cc/cdn_oilsnctw/sp/{fullNum}/{fullNum}_{voice}.m3u8");
                default:
                    switch (voice)
                    {
                        case parFreehat:
                            return new Uri(
                                $"https://serv1.freehat.cc/cdn_oilsnctw/sppar/{fullNum}/{fullNum}_{voice}.m3u8");
                        default:
                            return new Uri(
                                $"https://serv1.freehat.cc/cdn_oilsnctw/sp/{fullNum}/{fullNum}_{voice}.m3u8");
                    }
            }
        }

        public static string GetSpVoiceNameFreehat(int seasonNum, int episodeNum)
        {
            switch (seasonNum)
            {
                case 2:
